            ...
            <div class="w-2/3 flex flex-col bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="bg-gray-200 px-6 py-4">
                    ...
                    <div class="flex items-center pt-3">
                        <div class="bg-blue-700 w-12 h-12 flex justify-center items-center rounded-full uppercase font-bold text-white">CSTK</div>
                        <div class="ml-4">
                            <p class="font-bold">Klara</p>
                            <p class="text-sm text-gray-700 mt-1">Developer</p>
                        </div>
                    </div>
                </div>
            </div>
