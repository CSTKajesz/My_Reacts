        ...
        <section id="textdirectives">
            <ul class="container mx-auto leading-none divide-y divide-gray-400 divide-dotted" style="font-family: Raleway">
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-xs align-middle mb-2">Rex</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-sm align-middle mb-2">Dolores</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-base align-middle mb-2">Bubbles</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-lg align-middle mb-2">Fred</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-xl align-middle mb-2">Rivet</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-2xl align-middle mb-2">Eileen</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-3xl align-middle mb-2">Belle</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-4xl align-middle mb-2">Cosmo</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-5xl align-middle mb-2">Dolly</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-6xl align-middle mb-2">Sergeant</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-7xl align-middle mb-2">Oscar</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-8xl align-middle mb-2">Levi</div>
                ...
                <li class="flex items-center justify-between px-4 py-2">
                    <div>
                        <div class="text-9xl align-middle mb-2">Elton</div>
