...
const Filters = () => {
    return (
        <>
            <section>
                <div className="text-2xl border-t-8 border-b-2 mb-8">Toggle Classes</div>
                • filter, filter-none
                ...
                <p className="my-8 border-b-2" >
                    The blur filter gets an amount. You can use it without an amount and that would really be between the small and medium amount. I feel like the blur classes are a little agressive in terms of the strengths of the blurs though.                </p>
                ...
                <p className="my-8 border-b-2" >
                    The hue-rotate filter lets you rotate the colors in an image 360 degrees. To use it you specify an amount that goes from -180 to 180. The rotation is about a 30 degree offset, but there are some numbers clearly missing here after 90 degrees.
                </p>
                ...
                • sepia, sepia-0
                <p className="my-8 border-b-2" >
                    Sepia gives photo a duotone sort of style that looks pretty cool. It has a simple toggle style where you apply the filter with the sepia keyword and reset it with sepia-0                </p>
